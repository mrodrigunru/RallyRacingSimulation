...
public class PilotoExperimentadoTest
{
    ...
    public void setUp()
    {
        piloto = new PilotoExperimentado("PILOTO", concentracion.NORMAL);
    ...
    {
        assertEquals(0, piloto.getParticipacionEnCarreras());
        piloto.sumarUnaParticipacionEnCarreras();
        assertEquals(1, piloto.getParticipacionEnCarreras());
    }
    ...
    public void testCalcularDestreza()
    {
        ...
        assertEquals(0.9745384615384616, piloto.calcularDestreza(),0);
    }
    
    @Test
    public void testGetTipoPiloto()
    {
        assertEquals("PilotoExperimentado", piloto.getTipoPiloto());
    }
